const MastercardIcon = () => (
  <svg height="2rem" fill="none" viewBox="0 0 48 32" aria-hidden>
    <rect width="47" height="31" x="0.5" y="0.5" fill="#fff" rx="3.5" />
    <rect width="47" height="31" x="0.5" y="0.5" stroke="#D0D1D3" rx="3.5" />
