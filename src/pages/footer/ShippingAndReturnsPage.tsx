    ...
    <MainPageContainer heading={language.shippingAndReturns}>
      <section>
        ...
        <p>
          ...
          times depend on your location and the shipping method selected at
          checkout.
        </p>
        <p>
      ...
      <section>
        ...
        <p>
          ...
          before you complete your purchase. Delivery options may vary depending
          on your location.
        </p>
      </section>
      <section>
      ...
      <section>
        ...
        <ol>
          ...
          <li>
            Pack the item securely and include the required return information.
          </li>
      ...
      <section>
        ...
        <p>
          Please allow some time for the refund to appear in your account after
      ...
      <section>
        ...
        <p>
          If your order arrives damaged or you receive an incorrect item, please
          contact our customer service as soon as possible. We will help you
          resolve the issue.
        </p>
      </section>
      <section>
