    ...
    <MainPageContainer heading={language.privacy}>
      ...
      <section>
        ...
        <p>
          ...
          account, contact customer service or interact with our website. This
          may include your name, email address, shipping address, billing
      ...
      <section>
        ...
        <p>
          ...
          provide customer support. These providers only receive the information
      ...
      <section>
        ...
        <p>
          Payment information is processed securely by our payment providers. We
          do not store complete payment card details on our own systems.
        </p>
      </section>
      <section>
