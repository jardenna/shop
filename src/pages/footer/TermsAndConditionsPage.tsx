    ...
    <MainPageContainer heading={language.termsAndConditions}>
      ...
      <section>
        ...
        <p>
          ...
          email. An order is considered accepted once we have confirmed that the
          products are available and ready for delivery.
        </p>
        <p>
      ...
      <section>
        ...
        <p>
          ...
          currency and include applicable taxes unless otherwise stated. Payment
          is processed securely at the time of purchase.
        </p>
      </section>
      ...
      <section>
        <h2>Delivery</h2>
        <p>
          We aim to process and dispatch orders as quickly as possible. Delivery
          times may vary depending on the destination and selected shipping
          method.
        </p>
        <p>
      ...
      <section>
        ...
        <p>
          Once your return has been received and approved, we will process your
      ...
      <section>
        ...
        <p>
          We may update these terms and conditions from time to time. The terms
          that apply to your purchase are the terms available on the website at
