      ...
      <div className="generel-page-container">
        <section>
          ...
          <p>
            ...
            cancellations may not always be possible. Contact customer service
            as soon as possible if you need to make a change.
          </p>
        </section>
        <section>
          <h2>Payment</h2>
        ...
        <section>
          ...
          <p>
            Yes. When tracking is available, we will send you a tracking link
        ...
        <section>
          ...
          <p>
            Follow the return instructions provided with your order or contact
