...
const FaqPage = () => {
  ...
  return (
    <MainPageContainer heading={language.faq} className="general-page">
          ...
          <div className="section-item-container">
            <div>
              ...
              <p>
                ...
                checkout. Follow the steps to enter your delivery and payment
                details, then confirm your order.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                We process orders as quickly as possible, so changes or
                cancellations may not always be possible. Contact customer
                service as soon as possible if you need to make a change.
              </p>
            </div>
          </div>
        </section>
        <section>
          ...
          <div className="section-item-container">
            <div>
              ...
              <p>
                We accept the payment methods displayed at checkout. Available
          ...
          <div className="section-item-container">
            <div>
              ...
              <p>
                ...
                selected at checkout. You will receive tracking information when
                your order has been dispatched, where available.
              </p>
            </div>
            <div>
              <h3>Can I track my order</h3>
              <p>
                Yes. When tracking is available, we will send you a tracking
                link once your order has been dispatched.
              </p>
            </div>
          </div>
        </section>
        <section>
          ...
          <div className="section-item-container">
            ...
            <div>
              ...
              <p>
                Once we have received and approved your return, your refund will
        ...
        <section>
          ...
          <div className="section-item-container">
            <div>
              ...
              <p>
                Check our size guide for measurements and size conversions
            ...
            <div>
              ...
              <p>
                Availability can change over time. Check the product page again
                later for updated stock information.
              </p>
            </div>
          </div>
        </section>
